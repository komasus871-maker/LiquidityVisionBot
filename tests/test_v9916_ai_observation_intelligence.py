...
def _payload(action="ACCEPT_STANDARD"):
    ...
    return {
        ...
        "abstention": action == "ABSTAIN",
        "supporting_factors": [{"evidence_id": "bullish_structure", "statement": "bullish structure", "strength": 90}],
        "conflicting_factors": [{"evidence_id": "elevated_volatility", "statement": "elevated volatility", "severity": "MEDIUM"}],
        ...
        "evidence_ranking": [{"evidence_id": "bullish_structure", "rank": 1}],
