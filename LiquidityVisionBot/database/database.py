    ...
    with connect() as conn:
        ...
        conn.execute(f"""
            CREATE TABLE IF NOT EXISTS intelligence_snapshots(
                id {id_col}, signal_id BIGINT NOT NULL, created_at TEXT NOT NULL,
                confidence DOUBLE PRECISION NOT NULL, confidence_delta DOUBLE PRECISION NOT NULL,
                health TEXT NOT NULL, health_score DOUBLE PRECISION NOT NULL,
                trend DOUBLE PRECISION NOT NULL, structure DOUBLE PRECISION NOT NULL,
                liquidity DOUBLE PRECISION NOT NULL, momentum DOUBLE PRECISION NOT NULL,
                risk_used DOUBLE PRECISION NOT NULL, distance_to_stop DOUBLE PRECISION NOT NULL,
                mfe_giveback DOUBLE PRECISION NOT NULL, commentary TEXT,
                reasons_json TEXT NOT NULL, component_deltas_json TEXT NOT NULL,
                snapshot_json TEXT NOT NULL
            )
        """)
        conn.execute(f"""
            CREATE TABLE IF NOT EXISTS learning_samples(
                id {id_col}, signal_id BIGINT UNIQUE NOT NULL, symbol TEXT NOT NULL,
                timeframe TEXT NOT NULL, side TEXT NOT NULL, setup_key TEXT,
                result TEXT, status TEXT NOT NULL, duration_minutes INTEGER DEFAULT 0,
                realized_r DOUBLE PRECISION DEFAULT 0, mfe DOUBLE PRECISION DEFAULT 0,
                mae DOUBLE PRECISION DEFAULT 0, trend DOUBLE PRECISION DEFAULT 50,
                structure DOUBLE PRECISION DEFAULT 50, liquidity DOUBLE PRECISION DEFAULT 50,
                momentum DOUBLE PRECISION DEFAULT 50, confidence DOUBLE PRECISION DEFAULT 0,
                health_score DOUBLE PRECISION DEFAULT 0, features_json TEXT NOT NULL,
        ...
        for sql in (
            ...
            "CREATE INDEX IF NOT EXISTS idx_intelligence_snapshots_signal ON intelligence_snapshots(signal_id, created_at)",
            "CREATE INDEX IF NOT EXISTS idx_learning_samples_symbol ON learning_samples(symbol, timeframe, side)",
