...
EN = {
    ...
    "scanner.title": "Liquidity Vision · Scanner V2",
    ...
    "signal_quality.title": "Signal Quality V3", "contradictions.title": "Contradictions",
...
HE.update({
    ...
    "help.scanner": "הזדמנויות מדורגות ומסננים שקופים",
...
AR.update({
    ...
    "help.scanner": "فرص مرتبة ومرشحات شفافة",
